...
import 'package:ergata/screens/otp/patient/otp_form.dart';
import 'package:flutter/material.dart';

class OtpScreenPatient extends StatelessWidget {
  static String routeName = "/otp";

  final String phone;

  const OtpScreenPatient({super.key, required this.phone});
