...
class ChatRoomTherapist extends StatefulWidget {
  ...
  @override
  State<ChatRoomTherapist> createState() => _ChatRoomState();
}

class _ChatRoomState extends State<ChatRoomTherapist> {
  ...
  Future addMessage(String text) async {
    if (_messageController.text != "") {
      Map<String, dynamic> messageInfoMap = {
        "message": text,
        "sentBy": widget.therapist.id,
        "sentDate": Timestamp.now()
      };

      chatRepository
          .sendMessage(widget.chatRoomId, messageInfoMap, widget.patient.id)
          .then((value) {
              ...
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return chatMessageTile(
                        ds["message"], widget.therapist.id == ds['sentBy']);
                  })
              : Center(
